            ...
            <div class="card-body">
                <form action="" method="POST" class="form-item">
                    <div class="form-group">
                      ...
                      <input type="varchar(8)" name="npm" class="form-control col-md-9" placeholder="Masukkan NPM">
                     </div>

                     <div class="form-group">
                        <label for="nama">Nama</label>
                      <input type="varchar(100)" name="nama" class="form-control col-md-9" placeholder="Masukkan Nama">
                     </div>

                     <div class="form-group">
                        <label for="tempat_lahir">Tempat Lahir</label>
                      <input type="varchar(50)" name="tempat_lahir" class="form-control col-md-9" placeholder="Masukkan Tempat Lahir">
                     </div>
                     ...
                     <div class="form-group">
                      ...
                      <input type="enum('L','P')"name="jenis_kelamin" class="form-control col-md-9" placeholder="Masukkan Jenis Kelamin">
                     </div>
                     ...
                     <div class="form-group">
                      ...
                      <input type="varchar(5)" name="kode_pos" class="form-control col-md-9" placeholder="Masukkan Kodepos">
                     </div>
